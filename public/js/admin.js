const adminSocket = io((window.API_BASE || '') + '/admin');
...
async function setupCodeGeneration() {
  ...
  generateBtn.addEventListener('click', async () => {
    ...
    const r = await fetch(apiPath('/api/create-code'), {
      method: 'POST',
...
async function setupChatPurge() {
  ...
  purgeBtn.addEventListener('click', async () => {
    ...
    await fetch(apiPath('/api/purge-chat'), { method: 'POST' });
    alert('Chat purged');
  });
}
...
async function setupUserManagement() {
  ...
  deleteBtn.addEventListener('click', async () => {
    ...
    await fetch(apiPath('/api/user/delete'), {
      method: 'POST',
      headers: { 'content-type': 'application/json' },
  ...
  resetBtn.addEventListener('click', async () => {
    ...
    await fetch(apiPath('/api/user/change-password'), {
      method: 'POST',
      headers: { 'content-type': 'application/json' },
